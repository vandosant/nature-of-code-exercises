class Box  {
  ...
  Box(float _x, float _y, float _w, float _h) {
    ...
    vertices[0] = box2d.vectorPixelsToWorld(new Vec2(0,35));
    vertices[1] = box2d.vectorPixelsToWorld(new Vec2(20,10));
    vertices[2] = box2d.vectorPixelsToWorld(new Vec2(10,0));
    vertices[3] = box2d.vectorPixelsToWorld(new Vec2(-10,0));
    vertices[4] = box2d.vectorPixelsToWorld(new Vec2(-20,10));
